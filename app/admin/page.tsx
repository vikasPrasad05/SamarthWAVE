...
import { Upload, Trash2, Briefcase, Loader2, Lock, List, Image as ImageIcon } from "lucide-react";
                    ...
                    {deletingId === service.id ? (
                      <div className="flex gap-2 w-full mt-auto">
                        ...
                        <button 
                          ...
                          className="flex-1 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-lg transition-colors"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    {deletingId === img.id ? (
                      <div className="flex gap-2 w-full mt-3">
                        <button 
                          ...
                          className="flex-1 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs font-medium rounded-lg transition-colors"
                        >
                          Confirm
                        </button>
                        <button 
                          onClick={() => setDeletingId(null)}
                          className="flex-1 py-1.5 bg-gray-200 hover:bg-gray-300 text-gray-800 text-xs font-medium rounded-lg transition-colors"
                        >
                          Cancel
                        </button>
                      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
          <div>
            ...
            <p className="text-gray-500">Manage your services and gallery from one place</p>
          </div>
        ...
        <div className="mt-6">
          {activeTab === 'services' ? <AdminServices /> : <AdminGallery />}
        </div>
      </div>
    </div>
  );
